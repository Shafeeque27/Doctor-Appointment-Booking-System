        ...
        docInfo && (
            <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex-1 border bordgr400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 -mt-20 sm:mt-0">
                ...
                <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
                        ...
                        {docSlots.length &&
                            docSlots.map((daySlot, idx) => (
                                <div
                                    ...
                                    key={idx}>
                                    <p>{daySlot[0] && daysOfWeek[daySlot[0].datetime.getDay()]}</p>
                    ...
                    <button
                        ...
                        className="bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer transition active:scale-95">
                        Book an appointment
                    </button>
                </div>
