        ...
        dashData && (
            <div className="m-5">
                <div className="flex flex-wrap gap-3">
                    <div className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-95 transition-all">
                        ...
                        {dashData.latestAppointments.map((item, idx) => (
                            <div className="flex items-center px-6 py-3 gap-3 hover:bg-gray-100" key={idx}>
                                ...
                                <div className="flex-1 text-sm">
                                    <p className="texgr800 font-medium">{item.userData.name}</p>
                                    <p className="texgr600">{slotDateFormat(item.slotDate)}</p>
                                </div>
                                {item.cancelled ? (
